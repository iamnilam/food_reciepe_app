...
import 'package:food_reciepe_app/model.dart';
import 'package:food_reciepe_app/recipeView.dart';
                        ...
                        GestureDetector(
                          onTap: () {
                            if ((searchController.text).replaceAll(" ", "") ==
                              ...
                              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> SearchScreen(searchController.text)));
                            }
                          },
                          child: Container(
                            child: Icon(
